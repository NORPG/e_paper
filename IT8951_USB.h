...
void int1(SystemInfo *, int, int);
void int2(SystemInfo *, int, int);
void int3(SystemInfo *, int, int);
void int4(SystemInfo *, int, int);
void int5(SystemInfo *, int, int);
void int6(SystemInfo *, int, int);
void int7(SystemInfo *, int, int);
void int8(SystemInfo *, int, int);
void int9(SystemInfo *, int, int);
void int0(SystemInfo *, int, int);
